...
public class CustomAuthenticationFailureHandler extends SimpleUrlAuthenticationFailureHandler
{
            ...
            throws IOException, ServletException
    {
        if (LoginResponseType.JSON.equals(securityProperties.getAuthentication().getLoginType()))
        {
            ...
            response.getWriter().write(result.toJson    String());*/
            TransactionStatus transactionStatus = new TransactionStatus();
            transactionStatus.setError(exception.getMessage(), HttpStatus.UNAUTHORIZED.value() + "");
            response.setContentType("application/json;charset=UTF-8");
        ...
        else
        {
            ...
            String lastUrl =
                    toAuthentication != null ? securityProperties.getAuthentication().getLoginPage() : StringUtils.substringBefore(referer, "?");
